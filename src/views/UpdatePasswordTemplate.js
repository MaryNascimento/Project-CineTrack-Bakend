export function UpdatePasswordTemplate(updateUrl, user) {
  return `
    <!DOCTYPE html>
    <html lang="en">
    <head>
    ...
    <div style="width: 100%; background-color: #f9f9f9; padding: 20px;">
      <div style="background-color: #ffffff; width: 100%; max-width: 600px; margin: 0 auto; border-radius: 8px; overflow: hidden;">
        ...
        <div style="text-align: center; padding: 40px;">
          ...
          <p style="font-size: 16px; color: #555555; margin: 20px 0;">We received a request to reset your password. Click the link below to update your password.</p>
          <a href=${updateUrl} style="background-color: #7747FF; color: #ffffff; padding: 12px 30px; font-size: 18px; text-decoration: none; border-radius: 4px; display: inline-block; margin-top: 20px;">Confirm Email</a>
        </div>
      </div>
    </div>
  </body>
